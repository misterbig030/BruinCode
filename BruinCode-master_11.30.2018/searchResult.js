...
function showClasInfo(arr,index,sesNum){
        ...
        cell41.innerHTML=arr[index].notesNum+" notes available";
        ...
        button.onclick = function()
          {
            ...
            var oSession=$(this).parent().parent().prev().prev().prev().find('td')[1];//row4
            //localStorage.text=o.innerHTML;
            localStorage.setItem("oSess",oSession.innerHTML);


            window.location.href="lecInfo.html";
          }
          button.setAttribute("style","height:30px;width:100px;background-color:GhostWhite")
